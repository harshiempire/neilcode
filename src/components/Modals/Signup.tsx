...
const SignUp:React.FC<SignUpProps> = () => {
    ...
    const handleRegister= async(e:React.FormEvent<HTMLFormElement>)=>{
        e.preventDefault()
        if(!inputs.email || !inputs.password || !inputs.displayName) return alert("Please enter all the details")
        try{
    ...
    <h3 className='text-xl font-medium text-white'>Register to NeilCode</h3>
    <div>
