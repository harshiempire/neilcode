...
const Topbar:React.FC<TopbarProps> = ({problemPage}) => {
    ...
    <div className={`flex w-full items-center justify-between max-w-[1200px] mx-auto ${!problemPage} ? "max-w-[1200px] mx-auto" : ""`}>
        <Link href='/' className='h-[22px] flex-1'>
            <Image src='/logo-full.png' alt= 'Logo' height={100} width={100}/>
        </Link>
        {problemPage &&(
            <div className="flex items-center gap-4 flex-1 justify-center">
                <div className="flex items-center justify-center rounded bg-dark-fill-3 hover:bg-dark-fill h-8 w-8 cursor-pointer">
                    <FaChevronLeft/>
                </div>
